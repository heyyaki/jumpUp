...
public class DownListView extends LinearLayout {
    ...
    public DownListView(Context context) {
        ...
        name_Text = (TextView) findViewById(R.id.name_coin_down_txt);
        price_Text = (TextView) findViewById(R.id.price_coin_down_txt);
        down_per_Text = (TextView) findViewById(R.id.down_per_txt);
        image_coin = (ImageView) findViewById(R.id.image_coin_down);
    ...
    private void inflation_init(Context context) {
        ...
        inflater.inflate(R.layout.down_per, this, true);
    }
